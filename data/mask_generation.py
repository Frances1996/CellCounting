...
count = 0
data_path = 'E:\CellCounting\multiclass_dataset\MoNuSAC\MoNuSAC_Test' #Path to read data from
destination_path = 'E:\CellCounting\multiclass_dataset\MoNuSAC' # Path to save n-ary masks corresponding to xml files
os.chdir(destination_path)

try:
    os.mkdir(destination_path+r'\test_masks')
except OSError:
    print("Creation of the mask directory %s failed" % destination_path)

os.chdir(destination_path+r'\test_masks')#Create folder named as MoNuSAC_masks
